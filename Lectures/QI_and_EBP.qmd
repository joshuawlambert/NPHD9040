...
Use this tool: [Chi-square Calculator](http://modeling.nursing.uc.edu/statspicker/chimc.Rmd)
...
- University of Cincinnati's own tools:
    - [T-test Tool](http://modeling.nursing.uc.edu/statspicker/ttest.Rmd)
    - [Chi-square Tool](http://modeling.nursing.uc.edu/statspicker/chimc.Rmd)
...
- Excel’s Analysis Toolpak is more manual but lets you keep data in one place
    - The [T-test Tool](http://modeling.nursing.uc.edu/statspicker/ttest.Rmd) is faster and gives a summary statement
