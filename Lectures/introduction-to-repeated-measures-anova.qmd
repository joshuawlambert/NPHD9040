...
[**Download R Code for this Lecture**](code/introduction-to-repeated-measures-anova.R){ .btn .btn-primary }
...
ANOVA](introduction-to-anova.qmd) but accounts for the correlation between repeated measures on the
same subjects.
...
comparisons are made. When conducting multiple tests, the risk of a false positive (Type I error) increases significantly. For a detailed explanation of why this happens, see the section on [The Problem of Multiple Comparisons](introduction-to-anova.qmd#the-problem-of-multiple-comparisons) in the ANOVA lecture.
