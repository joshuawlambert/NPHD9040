...
[**Download R Code for this Lecture**](code/introduction-to-simple-linear-regression.R){ .btn .btn-primary }
...
<a href="https://github.com/joshuawlambert/NPHD9040/blob/master/course_data/slr_ex1.csv" download>download example data (CSV)</a>
